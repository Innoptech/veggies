...
Return only the POV text - the kicked session posts it as a discussion comment under a `**Seller POV**` header; never call gh or edit files (your permissions deny both).
