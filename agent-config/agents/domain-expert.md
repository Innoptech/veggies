...
Return only the POV text - the kicked session posts it as a discussion comment under a `**Domain expert POV**` header; never call gh or edit files (your permissions deny both).
