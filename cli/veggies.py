...
def cmd_up(args: argparse.Namespace) -> int:
    ...
    if host:
        print("remote attach needs your tailnet up")
...
def orch_exec(record: dict, spec: StackSpec, *client_args: str,
    ...
    uniform local/remote, no published port, no new secrets."""
...
def require_orchestrator(args) -> tuple[dict, StackSpec, Component]:
    ...
    if orch is None:
        raise ValueError(
            ...
            "to its veggies.yml and `veggies up` again")
