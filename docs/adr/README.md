...
| [0048](0048-agent-kick-install-as-one-module.md) | Install agent kicks as one terraform module block per repo | accepted (amended by 0054) |
...
| [0054](0054-comment-helper-joins-kick-delivery-set.md) | Comment helper joins the agent-kick delivery set (three files) | accepted |
